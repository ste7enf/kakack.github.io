...
四，动态代理
   ...
   - Java动态代理：知道其实现原理，适用场景，如：java动态代理对接口的内部调用为何不会被动态代理
   - cglib动态代理：知道其适用场景，优点和缺点，知道交易中心里有哪些场景用到了cglib
...
七，多线程并发
  ...
  - 线程池：ThreadPoolExecutor；了解线程池的使用方式和常用的几种线程策略；ScheduledThreadPoolExecutor
  - AtomicReference等类
  - 各种多线程同步和互斥工具：lock，condition，CountDownLatch
