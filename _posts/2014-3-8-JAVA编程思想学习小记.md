...
5. final关键字：其实是指一个值或者一个对象的引用不能被修改，但是可以通过修改被引用的对象中的内容
...
1. Collection，最基本的集合接口，都支持iterator()方法来遍历集合
   ...
   - Set
     - [HashSet](http://www.cnblogs.com/skywang12345/p/3311252.html)：最快的获取元素方式，同步访问，底层使用hashmap来保存元素，元素是无序的 

     - [TreeSet](http://www.cnblogs.com/skywang12345/p/3311268.html)：按比较顺序的升序保存对象，使用TreeMap实现，元素是有序的
...
2. Map：一种以key-value的形式保存
    ...
    - [HashMap](http://www.cnblogs.com/skywang12345/p/3310835.html)：类似HashTable，是非同步的，允许null值，默认的“加载因子”是0.75, 默认的容量大小是16，“实际容量” >= “阈值”时，(阈值 = 总的容量 * 加载因子)，就将HashMap的容量翻倍。只支持迭代器遍历。
